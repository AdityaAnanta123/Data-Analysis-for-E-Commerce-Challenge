...
---Menampilkan Transaksi per bulan ditahun 2020---
SELECT 
    EXTRACT
        (
            YEAR_MONTH FROM created_at
        ) AS tahun_bulan, 
...
---Menampilkan pengguna dengan rata-rata transaksi terbesar di Januari 2020---
---Code 1: Using AND---
SELECT 
    buyer_id, 
    COUNT(1) AS jumlah_transaksi, 
...
---Menampilkan Transaksi besar di Desember 2019---
---Code 1: Not using alias---
SELECT 
...
---Menampilkan Kategori Produk Terlaris di 2020---
SELECT 
    category, 
...
---Menampilkan pembeli yang sudah bertransaksi lebih dari 5 kali dan setiap transaksi lebih dari 2,000,000---
SELECT
    nama_user AS nama_pembeli,
    COUNT(1) AS jumlah_transaksi,
    SUM(total) AS total_nilai_transaksi,
